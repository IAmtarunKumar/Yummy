    ...
    <div class="container-footer w-container">
        <div class="w-row">
          <div class="footer-column w-clearfix w-col w-col-4"><img src="https://uploads-ssl.webflow.com/5966ea9a9217ca534caf139f/596d33f36607b12cfdaf8ad2_LogoWhite.png" alt="" width="40" class="failory-logo-image">
            ...
            <p class="footer-description-failory">For Better Deits! Yummy<br></p>
          </div>
          <div class="footer-column w-col w-col-8">
            <div class="w-row">
              <div class="w-col w-col-8">
                <div class="w-row">
                  <div class="w-col w-col-7 w-col-small-6 w-col-tiny-7">
                    <h3 class="footer-titles">Aboout Yummy</h3>
                    <p class="footer-links"><a href="" target="_blank"><span class="footer-link">Ymmy Startups<br></span></a><a href=""><span class="footer-link">Our Branches<br></span></a><a href=""><span class="footer-link">Blog</span></a><span><br></span><a href=""><span class="footer-link">Entrepreneurial Tools<br></span></a><a href=""><span class="footer-link">Projects<br></span></a><a href=""><span class="footer-link">Podcast</span></a><strong><br></strong></p>
                  </div>
              ...
              <div class="column-center-mobile w-col w-col-4">
                ...
                <p class="footer-description">Email me at: <a href=""><strong class="link-email-footer">yummy@gmail.com</strong></a><br></p>
              </div>
            </div>
          </div>
        </div>
